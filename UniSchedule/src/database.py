    ...
    def init_database(self):
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS notifications (
                ...
                type_notification TEXT NOT NULL CHECK(type_notification IN ('rattrapage', 'absence', 'annulation', 'info', 'alerte', 'reservation')),
                titre TEXT NOT NULL,
    ...
    def get_reservations_by_enseignant(self, enseignant_id):
        ...
        cursor.execute('''
            SELECT r.id, r.enseignant_id, s.nom as salle_nom, r.date, r.heure_debut, 
                   r.motif, r.statut, g.nom as groupe_nom, r.groupe_id
            FROM reservations r
