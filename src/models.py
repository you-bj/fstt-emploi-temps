...
class GestionnaireEmploiDuTemps:
    ...
    def generer_emploi_du_temps_groupe(self, groupe_id, matieres, semaine_debut=None):
        ...
        for jour in range(5):  # Lundi à Vendredi
            creneaux = Creneau.creer_creneaux_journee(jour)
            if jour == 4:  # Vendredi — skip 12:30-14:00 (lunch break)
                creneaux = [c for c in creneaux if not (c.heure_debut == "12:30" and c.heure_fin == "14:00")]
            creneaux_par_jour[jour] = creneaux
